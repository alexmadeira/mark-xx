...
import { heroBannerController, heroColorController } from '_SRV/controller'

import { useHeroBanner } from '_STR/useHeroBanner'

export function Title() {
  const heroBackground = useHeroBanner((st) => st.data.current.color)
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full flex-1 flex-col gap-0 px-[clamp(1.25rem,5vw,5rem)]">
        ...
        <h2 className="text-[clamp(1.125rem,5vw,6rem)] leading-[clamp(1.75rem,5vw,1)] font-light text-nowrap transition-colors duration-200">
          Desenvolvedor{' '}
          <TypeAnimation
            cursor
            wrapper="span"

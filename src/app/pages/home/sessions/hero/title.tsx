...
export const Title = memo(() => {
  ...
  return (
    <div
      style={{ ...CLHeroColor.betterContrast(current.color), opacity: header.height ? 1 : 0 }}
      className="relative z-1 mt-[clamp(1rem,4vw,5rem)] w-full flex-1 transition-opacity duration-300"
    >

...
export class VeronicaRequesterApi extends RequesterApi<TApiAxiosInstance> {
  static create(loader: ILoader, props?: TApiAxiosProps) {
    return new VeronicaRequesterApi(loader, props).setup()
  }

  private setup() {
    this.api = axios.create({
      baseURL: env.VITE_VERONICA_API,
    })
